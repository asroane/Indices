...
#Erini's code adapted from https://github.com/elambrid/bdnyc/blob/master/index_calc.py to work with astrodbkit.
...
def index_2inputs(dfspec,i,filename): #use for h2o indices
	dfindices = pd.read_csv(filename,names =['index_name','startw_num','endw_num','startw_dem','endw_dem'],skiprows = 1)
...
def index_3inputs(dfspec,i, filename): #use for grav sensitive indices
	#read in file
